...
The workflows in this directory are executed by specialized CI agents defined in `ci_workflows/`:

| Agent | Primary Workflow(s) | Purpose |
|-------|---------------------|---------|
| LintGuard | 03-code-review, 15-technical-debt | Static code analysis |
| PerfSmith | 13-performance-optimization | Performance insights |
| SchemaSage | 12-database-migration | Database audit & validation |
| ShieldProbe | 04-security-audit, 20-compliance | Security & privacy checks |
| AtlasReporter | 14-documentation-generation | Report consolidation |

**Full team documentation:** `ci_workflows/AGENT_TEAMS.md`
